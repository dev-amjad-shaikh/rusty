...
export function AgentWorkspace() {
  ...
  if (!connection) return <section className="page" aria-labelledby="agent-heading"><header className="page-header"><div><span className="eyebrow">Agents</span><h1 id="agent-heading">Open an agent</h1></div></header><div className="empty-state"><h2>Connect Rusty to load this agent</h2><p>The active definition and immutable history stay in your deployment.</p><button className="primary-button" type="button" onClick={openDialog}>Connect Rusty</button></div></section>;
