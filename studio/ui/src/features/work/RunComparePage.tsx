...
export function RunComparePage() {
  ...
  return <section className="page" aria-labelledby="compare-heading">
    ...
    {runs.length < 2 ? <div className="empty-state"><span className="eyebrow">Run comparison</span><h2>Complete two runs to compare them</h2><p>Finished runs from this page-memory session will appear here automatically.</p><Link className="primary-button" to="/work">Start work</Link></div>
